...
4. File manifest
	- C-language source code files: main.c, triangle.c, rectangle.c, square.c,
									horizon.c, intersect.c, circle.c, menu.c
	- C-language library files: triangle.h, rectangle.h, square.h,
								horizon.h, intersect.h, circle.h, menu.h
